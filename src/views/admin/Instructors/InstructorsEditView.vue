    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-success">Edition d'un instructeur</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="bgcolor2">
        ...
        <section class="form-section">
            ...
            <div class="form-container bgcolor1">
                <h2 class="text-center text-white fw-bold">Modifier un instructeur</h2>
...
onMounted(async () => {
    ...
    try {
        ...
        instructor.value = await instructorStore.fetchInstructorById(route.params.id);
        instructor.value.user_id = instructor.value.user?.id;
    } catch (error) {
