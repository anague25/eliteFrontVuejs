    ...
    <div class="table-container card">
        <div class="card-body">
            ...
            <div class="card-title my-0 py-0 ">
                <router-link to="/admin-create-video" class="float-end btn btn-sm btn-success ">Créer des
                    vidéos</router-link>
                        ...
                        <div v-for="chapter in course.chapters">
                            <div class="card" style="width: 14rem;">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <template v-if="chapter.videos?.length>0" v-for="video in chapter.videos">
                                        <li v-if="video.name" class="list-group-item">{{ video.name }}
                                            <div class="mb-3 p-1">
            ...
            <div v-if="courseStore.courses.length === 0">
                <td colspan="3" class="text-center">Aucune vidéo n'a été trouvé.</td>
            </div>
...
const editVideo = (id) => {
    router.push({ name: "editVideo", params: { id } });
};
