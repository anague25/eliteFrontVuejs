    ...
    <div class="bgcolor2">
        ...
        <section class="form-section">
            ...
            <div class="form-container bgcolor1">
                ...
                <form @submit.prevent="updateCategory" class="text">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select v-model="category.sub_sector_id" class="form-control">
                            ...
                            <option v-for="category in subSectorStore.allSubSectors" :key="category.id"
                                :value="category.id">
                                {{ category.name }}
                            </option>
                        </select>
                    ...
                    <div v-else class="mt-1 mb-2">
                        <img class="img" :src="$baseUrl + category.image" alt="" width="60" height="60" />
                    </div>
...
const category = ref({ id: null, name: "", sub_sector_id: "", description: "", image: "" });
const imageUrl = ref('');
...
onMounted(async () => {
    ...
    try {
        ...
        category.value = await categoryStore.fetchCategoryById(route.params.id);
        category.value.sub_sector_id = category.value.SubSector?.id;
    } catch (error) {
