    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-success">édition d'un chapitre</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="bgcolor2">
        ...
        <section class="form-section">
            ...
            <div class="form-container bgcolor1">
                <h2 class="text-center text-white fw-bold">Modifier un chapitre</h2>
                <form @submit.prevent="updateChapter" class="text">
                    <div class="mb-3">
                ...
                <div class="mt-2"><router-link to="/admin-chapters" class="text-decoration-none">Retour</router-link>
                </div>
            </div>
        </section>
    </div>
...
onMounted(async () => {
    ...
    try {
        ...
        chapter.value = await chapterStore.fetchChapterById(route.params.id);
    } catch (error) {
...
const updateChapter = async () => {
    try {
        await chapterStore.updateChapter(chapter.value);
