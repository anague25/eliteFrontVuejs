    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-success">Edition d'un cours</li>
            </ol>
        </nav>
    </div>
                ...
                <form @submit.prevent="updateCourse" class="text">
                    ...
                    <div class="mb-3">
                        ...
                        <select v-model="course.state" class="form-control">
                            <option value="" disabled selected>Veuillez choisir un niveau d'acces</option>
...
const course = ref({ instructor_id: "", language_id: "", header: "", title: "", image: "", state: "", price: "", levelStart: "", levelEnd: "", description: "", category_id: [] });
const getCourse = {};
const imageUrl = ref('');
