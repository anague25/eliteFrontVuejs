<template>
    ...
    <div class="table-container card">
        <div class="card-body">
            <h3 class="text-center text-uppercase text-white fw-bold mb-3">liste des plus recommandés</h3>
            ...
            <table class="custom-table">
                ...
                <tbody>
                    ...
                    <tr v-if="recommandationStore.courses.length === 0">
                        <td colspan="3" class="text-center">Aucune recommandation trouvé.</td>
                    </tr>
