    ...
    <div class="table-container card">
        <div class="card-body">
            ...
            <div class="card-title my-0 py-0 ">
                <router-link to="/users-dashboard/create-resource" class="float-end btn btn-sm btn-success ">Creer des
            ...
            <div class="d-flex flex-wrap gap-2 ">
                ...
                <div v-for="(course, index) in courseStore.getCoursesInstructor" :key="course.id" class="card" style="width: 35rem;">
            ...
            <div v-if="courseStore.getCoursesInstructor.length === 0">
                <p colspan="3" class="text-center">Aucun course n'a été trouvé.</p>
            </div>
...
const editResource = (id) => {
    router.push({ name: "userUpdateResource", params: { id } });
};
