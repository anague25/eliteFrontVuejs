    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-success">Créer un cours</li>
            </ol>
        </nav>
    </div>
    <div class="bgcolor2">
            ...
            <div class="form-container bgcolor1">
                ...
                <form @submit.prevent="createCourse" class="text">
                    ...
                    <div class="mb-3">
                        ...
                        <input v-model="course.price" min="1000" type="number" class="form-control"
...
const course = ref({ instructor_id: "", header: "", title: "", image: "", price: "", levelStart: "", levelEnd: "", description: "", category_id: [], language_id: [] });
...
const createCourse = async () => {
    try {
        course.value.instructor_id = instructorStore.getinstructor?.id;
        ...
        course.value = { instructor_id: "", header: "", title: "", image: "", price: "", levelStart: "", levelEnd: "", description: "", category_id: [], language_id: [] };
        imageUrl.value = "";
