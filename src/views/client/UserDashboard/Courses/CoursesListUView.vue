<template>
    ...
    <div class="table-container card">
        <div class="card-body">
            <h3 class="text-center text-uppercase text-white fw-bold mb-3">listes de vos cours</h3>
            <div class="card-title my-0 py-0 ">
                <router-link to="/users-dashboard/create-course" class="float-end btn btn-sm btn-success ">Créer un
                    cours</router-link>
            ...
            <div class="d-flex flex-wrap gap-2 ">
                ...
                <div v-for="(course, index) in courseStore.getCoursesInstructor" :key="course.id" class="card" style="width: 13rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">Prix : {{ (Number(course.price)).toFixed(2) }}</li>
            ...
            <div v-if="courseStore.getCoursesInstructor.length === 0">
                <p colspan="3" class="text-center">Aucun cours n'a été trouvé.</p>
            </div>
...
const toggleSelectAll = () => {
    if (selectAll.value) {
        selectedCourses.value = courseStore.getCoursesInstructor.map(course => course.id);
...
const editCourse = (id) => {
    router.push({ name: "userUpdateCourse", params: { id } });
};
